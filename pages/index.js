...
export default function LandingPage(props) {
  ...
  return (
    <Grid container direction="column" className={classes.mainContainer}>
      <Head>
        <title key="title">
          Custom Software, Mobile Apps, and Websites | Product Plus
        </title>
        <meta
          name="description"
          key="description"
        ...
        <meta
          property="og:title"
          content="Bringing West Coast Technology to the Midwest | Product Plus"
          key="og:title"
        />
        <meta property="og:url" key="og:url" content="productplus.com" />
