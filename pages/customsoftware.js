    ...
    <Grid container direction="column">
      <Head>
        ...
        <meta
          name="description"
          key="description"
          content="Cutting-Edge custom software development with gorgeous designs from scratch - Let us optimise your business and Solving Problems instead of creating new Ones."
        />
        <meta
          property="og:title"
        ...
        <meta
          property="og:url"
          key="og:url"
          content="productplus.com/customsotware"
        />
        <link rel="canonical" key="canonical" href="arc.com/customsotware" />
      </Head>
      <Grid
        item
        container
      ...
      <Grid
        ...
        direction="row"
        justify="center"
        style={{ marginTop: '7em', marginBottom: '20em' }}
        className={classes.rowContainer}
      >
        <Grid
          item
      ...
      <Grid
        item
        container
        alignItems={matchesMD ? 'cemter' : undefined}
